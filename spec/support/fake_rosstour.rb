...
class FakeRosstour < Sinatra::Base
  ...
  get '/gate/index.php', query: {service: 'tours', method: 'stars'} do
    json_response 200, 'tours_stars.json'
  end

  get '/gate/index.php', query: {service: 'tours', method: 'dates'} do
    json_response 200, 'tours_dates.json'
  end

  get '/gate/index.php', query: {service: 'tours', method: 'nights'} do
    json_response 200, 'tours_dates.json'
  end

  get '/gate/index.php', query: {service: 'tours', method: 'hotels'} do
